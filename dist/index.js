 ...
 */
export async function runAstGrep(args) {
 ...
 */
async function runAstGrepAsync(args) {
...
server.registerTool('ast_grep_search', {
    ...
    if (globs)
        globs.forEach((g) => args.push('--globs', g));
    if (extra_args)
...
server.registerTool('ast_grep_rewrite', {
...
// Tool: ast_grep_scan
server.registerTool('ast_grep_scan', {
